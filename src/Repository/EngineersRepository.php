...
/**
 * @extends ServiceEntityRepository<Engineers>
 *
...
class EngineersRepository extends ServiceEntityRepository
{
    ...
    public function save(Engineers $entity, bool $flush = false): void
    {
    ...
    public function remove(Engineers $entity, bool $flush = false): void
    {
